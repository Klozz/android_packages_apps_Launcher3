...
public class XPerienceLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "XPerienceLauncherModelDelegate";
    ...
    public XPerienceLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
